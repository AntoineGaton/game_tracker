...
- add a way to add the game to the database after searching for it on HowLongToBeat and check if game already exists in the database and if game exists on Steam db
