...
def how_long_to_beat():
   ...
   hltb = HowLongToBeat()
results = hltb.search("The Last of Us")

for result in results:
    print(f"Game: {result.game_name}")
    print(f"Main Story: {result.gameplay_main} hours")
    print(f"Main + Extras: {result.gameplay_main_extra} hours")
    print(f"Completionist: {result.gameplay_completionist} hours")
