...
def how_long_to_beat():
   ...
   for result in results:
      ...
      print('Game Name: ', result.game_name)
      print('All Styles: ', result.all_styles)
      print('Main Story: ', result.main_story)
      print('Similarity: ', result.similarity)
      print('Completionist: ', result.completionist)
      print('JSON content: ', result.json_content)
      print('--------------------------------')
