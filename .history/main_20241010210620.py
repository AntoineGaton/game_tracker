...
'''
To Do:
- implement getting data from HowLongToBeat to calculate percentage of completion
- add a way to add the game to the database after searching for it on HowLongToBeat and check if game already exists in the database and if it does, update the hours played
...
def how_long_to_beat():
   ...
   hltb = HowLongToBeat()
   hltb.minimum_similarity = 0.5  # Set the minimum similarity threshold (0.0 to 1.0)
   ...
   try:
      ...
      for result in results:
         ...
         print(f"Main + Extras: {result.main_extra} hours")
         print(f"Completionist: {result.completionist} hours")
         print('===================================')
   
      print('Which game do you want to add to the database?')
